...
{
    class NormalFlight //This will inherit from a virtual base class
    {
        private static string flightMode = "Normal Flight"; //Name of the behavior

        public NormalFlight()
        {
            //Set parameters if using base methods
        }
